...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  final List<OnboardingSlideData> _slides = [
    const OnboardingSlideData(
      ...
      description:
          'Explore a curated catalog of wisdom, motivation, and humor from history\'s greatest minds.',
    ...
    const OnboardingSlideData(
      ...
      description:
          'Build your personal library of quotes that speak to you. Keep them close for whenever you need a lift.',
    ...
    const OnboardingSlideData(
      ...
      description:
          'Unlock premium features, remove ads, export stunning image cards, and receive daily wisdom collections.',
  ...
  void _navigateToLogin() {
    ...
    Navigator.of(
      context,
    ).pushReplacement(SlideRightToLeftRoute(page: const LoginScreen()));
  }
